...
type AryanSaleCustomer struct {
	CustomerID   int    `json:"customer_id"`
	CustomerCode string `json:"customer_code"`
}

type AryanSaleTypeSelect struct {
