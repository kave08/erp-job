...
type FararavandBaseData struct {
	PaymentTypes []struct {
		ID   int    `json:"id"`
...
type FararavandProducts struct {
	ID                        int     `json:"id"`
	Name                      string  `json:"name"`
...
type FararavandCustomers struct {
	ID                int    `json:"id"`
...
type FararavandInvoices struct {
...
type FararavandTreasuries struct {
...
type FararavandReverted struct {
	BranchID                 int    `json:"branchId"`
	CodeDoreh                int    `json:"codeDoreh"`
	InvoiceID                int    `json:"invoiceId"`
